...
#define Ultraschall_Delay 200 // Wartedauer nach Ultraschallmessung
...
#define Led_Dimming 10


//Variablen für den Ultraschallsensor
int maximumRange = 20;
int maximumRangeFix = 180;
int minimumRange = 20;
int minimumRangeFix = 180;
...
int sensorDark = 980; //Wert der unterschritten werden muss, damit der Raum als dunkel gilt
...
void ultraschall_1() {
  ...
  Abstand = Dauer / 58.2;
  Serial.print("Abstand Sensor1: ");
  Serial.println(Abstand);
  if (Abstand >= minimumRangeFix || Abstand <= maximumRangeFix) {
    wasTrueS1[0] = false;
    wasTrueS1[1] = false;
    wasTrueS1[2] = false;
